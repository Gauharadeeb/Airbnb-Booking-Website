      ...
      <div className="grid mb-3">
        <div className="">
          ...
          <div className="gap-4 grid grid-cols-2">
            <div className="flex gap-2 border border-blue-300 justify-start items-center px-4 py-2 rounded-md">
            ...
            <div className="flex gap-2 border border-blue-300 justify-start items-center px-4 py-2 rounded-md">
              <input type="checkbox" checked={selected.includes('parking')} name="parking" id=""onChange={handleCheckboxClick} />
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div className="flex gap-2 border border-blue-300 text-center justify-start items-center px-4 py-2 rounded-md">
            ...
            <div className="flex gap-2 border border-blue-300 text-center justify-start items-center px-4 py-2 rounded-md">
              <input type="checkbox" checked={selected.includes('radio')} name="radio" id=""onChange={handleCheckboxClick} />
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
